...
export class WishlistPage implements OnInit {
  ...
  ngOnInit() {
    ...
    this.activities = [
      ...
      {id: 2, username: 'erickmiller', user_profile: 'assets/imgs/6.png', time: '5 mins', activity: 'comment',
       comments: 'Great content without a doubt. I am your big fan of you.', post: 'assets/imgs/posts/12.jpg'},
      ...
      {id: 5, username: 'iq.code', user_profile: 'assets/imgs/5.png', time: '5 mins', activity: 'comment',
       comments: 'Nice design. It\'s good to see different layouts and design for such commons elements. Good job!.',
        post: 'assets/imgs/posts/11.jpg'},
